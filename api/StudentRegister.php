...
if ($conn->connect_error) {
    ...
    if ($UniversityID == null) {
        ...
        // Insert student user into User table with 'Student' role
        $UserID = insertUser($conn, $FirstName, $LastName, $Login, $Password, $Role);

        // Associate user as an student with the specified university
        insertStudent($conn, $UserID, $UniversityID);

        returnWithInfo("Student added to the university successfully.");
    }
}
